...
class SortedListPriorityQueueTest {
	...
	void teste_comparador_de_Pessoa() {
		...
		// **** Usando um Comparador Específico de Pessoa (baseado na idade)
		// implementado dentro de Pessoa *****
	...
	void teste_comparador_externo_de_Pessoa() {
		...
		// **** Usando um Comparador Específico de Pessoa (baseado no nome) implementado
		// externamente *****
